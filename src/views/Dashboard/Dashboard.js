...
import { table_data } from '../../variables/general'
    ...
    table_data.map((tdata, i) => (
      tableRows.push(
        <tr key={i}>
          <td>
            <div className="flag">
              <img src={tdata.flag} alt="us_flag" />
            </div>
          </td>
          <td>{tdata.country}</td>
          <td className="text-right">{tdata.count}</td>
          <td className="text-right">{tdata.percentage}</td>
        </tr>
      )
    ))
    return tableRows
              ...
              <Card className="card-chart">
                <CardHeader>
                  ...
                  <UncontrolledDropdown>
                    ...
                    <DropdownMenu right>
                      <DropdownItem>Acttion</DropdownItem>
                ...
                <CardBody>
                  ...
                  <div className="card-progress">
                    <div className="progress-container">
                      <span className="progress-badge">Delibery Rate</span>
